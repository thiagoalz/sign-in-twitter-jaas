...
*/
public class MySimpleGroup extends MySimplePrincipal implements Group, Cloneable
{
   ...
   private HashMap members;
    ...
    public MySimpleGroup(String groupName)
    {
        super(groupName);
   ...
   {  
      MySimpleGroup clone = (MySimpleGroup) super.clone();  
      if(clone != null) 
